...
from linebot.models import TextMessage, TemplateSendMessage, ButtonsTemplate, URIAction
from linebot.models import PushMessageRequest # 引入 PushMessageRequest 模組
...
import Backup.connect_db as connect_db
...
def get_gemini_recommendation(line_user_id, reply_token, api: MessagingApi):
    ...
    - **本次消費類別**: {category}
    - **預估消費金額**: {amount}元
    - **使用者目前擁有的支付工具**: LINE Pay、街口支付、台新GOGO卡、玉山UBear卡、國泰Cube卡
